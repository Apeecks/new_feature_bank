...
# => generators
@pytest.fixture
def no_sort_transactions() -> list:
    """Неотсортированный список словарей, RUB/USD, src/generators.py"""
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
@pytest.fixture
def sort_usd_one_filter_by_currency() -> dict:
    """Неотсортированный список словарей первый вызов, RUB/USD, src/generators.py"""
    return {
        "id": 939719570,
        "state": "EXECUTED",
        "date": "2018-06-30T02:08:58.425572",
...
@pytest.fixture
def sort_usd_two_filter_by_currency() -> dict:
    """Отсортированный список словарей второй вызов, RUB/USD, src/generators.py"""
    return {
        "id": 142264268,
        "state": "EXECUTED",
        "date": "2019-04-04T23:20:05.206878",
